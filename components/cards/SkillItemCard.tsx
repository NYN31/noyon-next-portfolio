...
const SkillItemCard: React.FC<{ skill: TechSkills }> = ({ skill }) => {
  return (
    <div className="flex flex-row items-center gap-3 pr-3 max-w-[100%] bg-white dark:bg-gray-800 text-sm font-medium hover:font-bold rounded-lg border border-gray-300 dark:border-gray-600 shadow-lg shadow-black/[0.03]">
