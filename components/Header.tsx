        ...
        <ul className="flex flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium text-gray-500 md:w-[initial] md:flex-nowrap md:gap-3">
          {NAVBAR_LINKS.map(link => {
            return (
              ...
              >
                <Link
                  className="flex w-full items-center justify-center px-3 py-2 md:py-3 text-gray-950 font-semibold hover:text-gray-500 transition dark:text-gray-500 dark:hover:text-gray-300"
                  href={link.hash}
                >
                  {link.name}
                </Link>
